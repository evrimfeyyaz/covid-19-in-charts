...
const ShareButtons: FunctionComponent<ShareButtonsProps> = ({ title, url, small = false }) => {
  ...
  return (
    <div className={small ? "small" : undefined}>
      ...
      >
        <div
          className="resp-sharing-button resp-sharing-button--linkedin resp-sharing-button--small">
          <div
            aria-hidden="true"
            className="resp-sharing-button__icon resp-sharing-button__icon--solid"
          >
      ...
      >
        <div
          className="resp-sharing-button resp-sharing-button--hackernews resp-sharing-button--small">
          <div
            aria-hidden="true"
            className="resp-sharing-button__icon resp-sharing-button__icon--solid"
          >
