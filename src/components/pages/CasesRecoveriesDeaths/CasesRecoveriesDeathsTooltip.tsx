...
const CasesRecoveriesDeathsTooltip: FunctionComponent<CasesRecoveriesDeathsTooltip> = ({
  payload,
  active,
}) => {
  if (!active) {
  ...
  return (
    <Card className="shadow rounded-lg">
      <Card.Body className="rounded-lg pt-3 pb-2 px-4 small" style={{ lineHeight: 1 }}>
        <Card.Title className="text-center">{prettifyMDYDate(date)}</Card.Title>
        <Card.Text as="div">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className="text-right">
                  {recovered != null ? numToGroupedString(recovered) : "n/a"}
                </td>
              </tr>
              <tr style={{ height: 5 }} />
              <tr>
                ...
                <th>Deaths</th>
                <td className="text-right">
                  {deaths != null ? numToGroupedString(deaths) : "n/a"}
                </td>
              </tr>
            </tbody>
          </Table>
