...
const CasesRecoveriesDeathsLegend: FunctionComponent<CasesRecoveriesDeathsLegendProps> = ({
  payload,
  data,
}) => {
    ...
    >
      {latestConfirmed != null && (
        <div className="flex-1">
          <div className="py-1" style={{ backgroundColor: payloadConfirmed?.color }}>
            Confirmed
          </div>
      ...
      {latestNewConfirmed != null && (
        <div className="flex-1">
          <div className="py-1" style={{ backgroundColor: payloadNewConfirmed?.color }}>
            New
          </div>
      ...
      {latestRecovered != null && (
        <div className="flex-1">
          <div className="py-1 text-light" style={{ backgroundColor: payloadRecovered?.color }}>
            Recovered
          </div>
      ...
      {latestDeaths != null && (
        <div className="flex-1">
          <div className="py-1 text-light" style={{ backgroundColor: payloadDeaths?.color }}>
            Deaths
          </div>
